...
void Initialisation_Ennemy(Ennemy * e)
{
int n ;
//Ennemy en [MAX_enemi] ;
srand(time(NULL)) ;
...
void afficher_Ennemy(Ennemy *e,SDL_Surface *ecran)
{
/*if(e->Direction)
{
...
void deplacer(Ennemy *e , SDL_Rect posperso)
{
int dist = (posperso.x - e->Position.x);
